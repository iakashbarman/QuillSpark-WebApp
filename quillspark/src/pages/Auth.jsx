      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="max-w-md mx-auto">
            <div className="rounded-2xl frosted p-12 border-[rgba(255,255,255,0.03)] shadow-inner">
              <div className="flex flex-col items-center">
                <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#b892ff] to-[#7b5bff] mb-6 flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="text-white">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#b892ff] text-center mt-8">Welcome Back!</h2>
            <p className="text-center text-indigo-200 mt-3 max-w-sm mx-auto">To keep connected verify yourself with your personal info</p>
          </div>

          {/* Right card: embed Clerk SignIn / SignUp widget */}
          <div className="max-w-md mx-auto">
            <div className="rounded-2xl frosted p-8 border-[rgba(255,255,255,0.03)] shadow-inner">
              ...
              <SignedIn>
                <div className="text-sm text-indigo-200 text-center">You are already signed in. Redirecting...</div>
              </SignedIn>
            </div>
          </div>
        </div>
